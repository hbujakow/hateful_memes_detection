...
def parse_opt():
    ...
    parser.add_argument("--MODEL", type=str, default="pbm")  # can be changed to 'bert'
    ...
    parser.add_argument('--LOG_PATH', type=str, default='/home2/faculty/mgalkowski/memes_analysis/hateful_memes/Pro-Cap/logs')
