...
#SBATCH --output=/home2/faculty/wjakubowski/logs/llava/finetuned_inference_run_inference_train.log
...
python run_inference.py \
    ...
    --dest-file "/home2/faculty/wjakubowski/memes_analysis/data/dev_seen_with_predictions.json"