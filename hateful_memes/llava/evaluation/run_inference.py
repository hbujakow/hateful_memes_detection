...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model-path",
        type=str,
        default="/home2/faculty/wjakubowski/memes_analysis/hateful_memes/llava/LLaVA/checkpoints/llava-v1.5-13b-lora",
    )
    ...
    parser.add_argument(
        "--dest-file",
        type=str,
        default="/home2/faculty/wjakubowski/memes_analysis/data/dev_seen_predictions.jsonl",
    )
    parser.add_argument(
        "--prompt",
        type=str,
